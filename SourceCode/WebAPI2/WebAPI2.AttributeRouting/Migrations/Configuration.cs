namespace WebAPI2.AttributeRouting.Migrations
{
    using Models;
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<WebAPI2.AttributeRouting.Models.BooksAPIContext>
    {
        ...
        protected override void Seed(WebAPI2.AttributeRouting.Models.BooksAPIContext context)
        {
